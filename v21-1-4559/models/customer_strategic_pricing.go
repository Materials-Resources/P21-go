...
type CustomerStrategicPricing struct {
	...
	WarehouseSizeCd             *int32           `bun:"warehouse_size_cd,type:int"`                                   // Warehouse size: Very Tiny/Tiny/Small/Medium/Large/Huge
	WarehouseSizeUpdateDate     *mssql.DateTime1 `bun:"warehouse_size_update_date,type:datetime"`                     // Date warehouse size was last updated
	RetailSizeCd                *int32           `bun:"retail_size_cd,type:int"`                                      // Retail size: Very Tiny/Tiny/Small/Medium/Large/Huge
	RetailSizeUpdateDate        *mssql.DateTime1 `bun:"retail_size_update_date,type:datetime"`                        // Date retail size was last updated
	CustomerCategoryUid         *int32           `bun:"customer_category_uid,type:int"`                               // Indicates the customer category
	...
	PricingCustomerId           *float64         `bun:"pricing_customer_id,type:decimal(19,0)"`                       // The pricing customer/company is the customer used to determine pricing information.  The user can group customers who all get the same price.
	...
	CustSensitivityUpdateDate   *mssql.DateTime1 `bun:"cust_sensitivity_update_date,type:datetime"`                   // Date customer sensitivity was last updated
