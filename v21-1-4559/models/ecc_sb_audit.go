...
type EccSbAudit struct {
	...
	EccSbAuditUid          int32   `bun:"ecc_sb_audit_uid,type:int,autoincrement,identity,pk"`
	...
	AuditTriggerData       string  `bun:"audit_trigger_data,type:char(1)"`
	AuditTargetData        string  `bun:"audit_target_data,type:char(1)"`
	TransferType           *string `bun:"transfer_type,type:varchar(255)"`
	TableName              *string `bun:"table_name,type:varchar(255)"`
	TriggerName            *string `bun:"trigger_name,type:varchar(255)"`
}
