...
type Periods struct {
	...
	BeginningDate        *mssql.DateTime1 `bun:"beginning_date,type:datetime"`                              // What is the beginning date for this period?
	EndingDate           *mssql.DateTime1 `bun:"ending_date,type:datetime"`                                 // When is the end of this period?
	...
	PeriodReopened       *string          `bun:"period_reopened,type:char(1)"`                              // A flag to determine whether a period has been reopened
}
