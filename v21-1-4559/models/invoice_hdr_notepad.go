...
type InvoiceHdrNotepad struct {
	...
	ActivationDate       mssql.DateTime1 `bun:"activation_date,type:datetime"`                        // Starting date of the note.
	ExpirationDate       mssql.DateTime1 `bun:"expiration_date,type:datetime"`                        // Expiration date of the note.
	EntryDate            mssql.DateTime1 `bun:"entry_date,type:datetime"`                             // Entry date of the note.
