...
type GporRun struct {
	...
	RequiredDate                  *mssql.DateTime1 `bun:"required_date,type:datetime"`
	DueDate                       *mssql.DateTime1 `bun:"due_date,type:datetime"`
	...
	LastSaleDate                  *mssql.DateTime1 `bun:"last_sale_date,type:datetime"`
	...
	LookAheadDate                 *mssql.DateTime1 `bun:"look_ahead_date,type:datetime"` // Look ahead date for the GPOR run
	ReasonWhyNotDrpCd             *int32           `bun:"reason_why_not_drp_cd,type:int"`
	OrderQuantityDate             *mssql.DateTime1 `bun:"order_quantity_date,type:datetime"`       // column to hold the eoq order date
