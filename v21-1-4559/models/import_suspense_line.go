...
type ImportSuspenseLine struct {
	...
	BoInstancename        *string   `bun:"bo_instancename,type:varchar(255)"`                         // Internal use - identifies the business objects associated with the file- often the same as the table being updated
	...
	CustomerId            *float64  `bun:"customer_id,type:decimal(19,0)"`                            // used for sales order imports, the customer id of the order header record
	LocationId            *float64  `bun:"location_id,type:decimal(19,0)"`                            // used for sales order imports, the sales location id of the order header record
	KeyValue              *string   `bun:"key_value,type:varchar(255)"`                               // Used for sales order imports, identifies the order number of an imported order for which a line item failed
	KeyValueTable         *string   `bun:"key_value_table,type:varchar(255)"`                         // Used for sales order imports, identifies the table associated with the key_value
	...
	SourceId              *string   `bun:"source_id,type:varchar(8)"`                                 // web reference number of B2BSeller Sales Order imports
}
