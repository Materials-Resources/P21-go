...
type ItemLeadTime struct {
	...
	ReceiptDate         mssql.DateTime1 `bun:"receipt_date,type:datetime"`                                    // The approximate date a transfer will be received at the destination location.
	PoNo                *float64        `bun:"po_no,type:decimal(19,0)"`                                      // System-generated number assigned to a purchase order.
	PoDate              mssql.DateTime1 `bun:"po_date,type:datetime"`                                         // The date this purchase order was generated.
