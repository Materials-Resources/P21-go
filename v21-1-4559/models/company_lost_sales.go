...
type CompanyLostSales struct {
	...
	CompanyLostSalesUid int32           `bun:"company_lost_sales_uid,type:int,autoincrement,identity,pk"`    // Unique identifier for company lost sales table
	...
	LostSalesUid        *int32          `bun:"lost_sales_uid,type:int"`                                      // Reference to the lost sales UID for defaulting
