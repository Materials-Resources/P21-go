...
type ItemCategory struct {
	...
	CatalogPage              *string   `bun:"catalog_page,type:varchar(255)"`                               // Alphanumeric ID of the catalog page
	...
	SubCategoryImageFile     *string   `bun:"sub_category_image_file,type:varchar(255)"`                    // image file location for sub category
}
