...
type WzdProcessExtP21 struct {
	...
	PanelTx         *string `bun:"panel_tx,type:varchar(60)"`                          // Display text for Wizard panel override
	PanelPic        *string `bun:"panel_pic,type:varchar(30)"`                         // Display graphic for Wizard panel override
	PanelObj        *string `bun:"panel_obj,type:varchar(60)"`                         // Custom PowerBuilder User Object override
	AddtlTx         *string `bun:"addtl_tx,type:text"`                                 // Additional user instructions
