...
type OeLineLastMarginPrice struct {
	...
	PrevSkuPrice             *float64        `bun:"prev_sku_price,type:decimal(19,9)"`                                // Previous SKU Price
	PrevQtyOrdered           *float64        `bun:"prev_qty_ordered,type:decimal(19,9)"`                              // Previous Qty Ordered
	PrevProfitPercent        *float64        `bun:"prev_profit_percent,type:decimal(19,9)"`                           // Previous Profit Percent
	...
	CostBasisCdUsed          *int32          `bun:"cost_basis_cd_used,type:int"`                                      // The cost basis that was used to determine the previous profit percent
