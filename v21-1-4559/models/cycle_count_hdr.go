...
type CycleCountHdr struct {
	...
	DateLastCountedBefore          *mssql.DateTime1 `bun:"date_last_counted_before,type:datetime"`                        // A particular date specified to produce a manual count list with only the items that have a date last counted before MM/DD/YYYY.
