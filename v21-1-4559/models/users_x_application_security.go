...
type UsersXApplicationSecurity struct {
	...
	CodeValue              *int32    `bun:"code_value,type:int"`                                          // Code (int) value for this record. Will contain only codes for code_p21
	DecimalValue           *float64  `bun:"decimal_value,type:decimal(19,9)"`                             // Decimal value for this record.
	StringValue            *string   `bun:"string_value,type:varchar(255)"`                               // String value for this record.
