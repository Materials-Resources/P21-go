...
type AssemblyHdr struct {
	...
	Class1                       *string         `bun:"class1,type:varchar(255)"`                                      // What is the assembly class?
	Class2                       *string         `bun:"class2,type:varchar(255)"`                                      // What is the assembly class?
	Class3                       *string         `bun:"class3,type:varchar(255)"`                                      // What is the assembly class?
	Class4                       *string         `bun:"class4,type:varchar(255)"`                                      // What is the assembly class?
	Class5                       *string         `bun:"class5,type:varchar(255)"`                                      // What is the assembly class?
	...
	ExtendedDesc                 *string         `bun:"extended_desc,type:varchar(255)"`                               // Extended description.
	...
	HoseUnitOfMeasure            *string         `bun:"hose_unit_of_measure,type:varchar(8)"`                          // Unit of measure for the hose length
	CreatedBy                    *string         `bun:"created_by,type:varchar(255),default:(suser_sname())"`
	Type                         *int32          `bun:"type,type:int"`                                               // Custom: F25838 - identifies the assembly type (regular, master or pro-rated).  See the code_p21 table for associated values.
	ProcessUid                   *int32          `bun:"process_uid,type:int"`                                        // Pre-defined Routing Associated with the Assembly
	...
	AutoExpandFlag               *string         `bun:"auto_expand_flag,type:char(1)"`                               // Indicates if kit should be auto-expanded
	BypassOeProdOrderProcessing  *string         `bun:"bypass_oe_prod_order_processing,type:char(1)"`                // Custom: Default value for the bypass prod order option in OE.
	AssemblyClassUid             *int32          `bun:"assembly_class_uid,type:int"`
