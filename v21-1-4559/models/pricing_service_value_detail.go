...
type PricingServiceValueDetail struct {
	...
	OriginalValue    *string   `bun:"original_value,type:varchar(50)"`                           // The value from the import file to match on
	ConvertedValue   *string   `bun:"converted_value,type:varchar(50)"`                          // The value to change the import file value to when a match is found
