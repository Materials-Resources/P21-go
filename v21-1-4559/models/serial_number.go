...
type SerialNumber struct {
	...
	AllowanceAmountModifiedDate *mssql.DateTime1 `bun:"allowance_amount_modified_date,type:datetime"`                  // (Custom) Date that allowance_amount field was last modified
