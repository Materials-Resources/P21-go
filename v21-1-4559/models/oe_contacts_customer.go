...
type OeContactsCustomer struct {
	...
	CreditCardNo             *string          `bun:"credit_card_no,type:varchar(255)"`                          // Numeric code that appears on the customers credit card.
	CreditCardType           *string          `bun:"credit_card_type,type:varchar(255)"`                        // The type of credit card the customer is using.
	CreditCardName           *string          `bun:"credit_card_name,type:varchar(255)"`                        // The name of a person or organization, as it appears on the credit card.
