...
type ScheduledImportDetails struct {
	...
	Fileprefix                *string   `bun:"fileprefix,type:varchar(20)"`                               // File prefix that the scheduled import service will use to identify the files data and transaction set.
