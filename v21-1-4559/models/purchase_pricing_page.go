...
type PurchasePricingPage struct {
	...
	DiscountGroupId        *string         `bun:"discount_group_id,type:varchar(8)"`                         // What is the unique identifier for this discount group?
	MajorGroupId           *string         `bun:"major_group_id,type:varchar(8)"`                            // When the totaling method is major_group, this column can be used to combine items from different pricing pages.
	PricingDescription     *string         `bun:"pricing_description,type:varchar(40)"`                      // Description of the purchase pricing page
	PricingMethod          string          `bun:"pricing_method,type:varchar(16)"`                           // Indicates what base price should be used (source, price, or none)
	SourcePrice            *string         `bun:"source_price,type:varchar(40)"`                             // If pricing method is Source, this indicates the price to be used (supplier list or supplie cost)
	Price                  *float64        `bun:"price,type:decimal(19,9)"`                                  // If pricing method is Price, this is the base price used by this pricing page
	EffectiveDate          mssql.DateTime1 `bun:"effective_date,type:datetime"`                              // When does this purchase pricing page go into effect
	ExpirationDate         mssql.DateTime1 `bun:"expiration_date,type:datetime"`                             // When does this page expire?
	ContractNumber         *string         `bun:"contract_number,type:varchar(40)"`                          // The contract number for this page
	...
	LocationId             *float64        `bun:"location_id,type:decimal(19,0)"`                // column indicates the location of the pricing page
