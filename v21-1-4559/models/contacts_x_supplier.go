...
type ContactsXSupplier struct {
	...
	DateCreated      mssql.DateTime1 `bun:"date_created,type:datetime"`                  // Date/time this record was created
	DateLastModified mssql.DateTime1 `bun:"date_last_modified,type:datetime"`            // Date/time this record was last modified
