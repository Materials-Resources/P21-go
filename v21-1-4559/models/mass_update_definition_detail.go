...
type MassUpdateDefinitionDetail struct {
	...
	MassUpdateDefinitionDetailUid int32     `bun:"mass_update_definition_detail_uid,type:int,autoincrement,identity,pk"` // Unique Identifier of mass_update_definition table
