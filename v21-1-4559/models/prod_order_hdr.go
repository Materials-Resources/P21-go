...
type ProdOrderHdr struct {
	...
	ExpediteDate             *time.Time `bun:"expedite_date,type:datetime"`                            // The date in which this production order needs to be expedited in order to get assembly out on time
	...
	ReleaseDate              *time.Time `bun:"release_date,type:datetime"`                             // The date when the order is released to production
