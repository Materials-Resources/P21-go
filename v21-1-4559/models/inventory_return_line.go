...
type InventoryReturnLine struct {
	...
	ExtendedDescription    *string         `bun:"extended_description,type:varchar(255)"`                    // Extended description for the item on the return.
	...
	ReturnDate             mssql.DateTime1 `bun:"return_date,type:datetime,default:(getdate())"`             // Date line was entered.
	...
	SupplierPartNumber     *string         `bun:"supplier_part_number,type:varchar(255)"`                    // The part number according to the supplier.
