...
type HelpTopic struct {
	...
	Topic            *int32    `bun:"topic,type:int"`                                            // The topic of the note for the referenced area.
	...
	Verified         *string   `bun:"verified,type:char(1)"`                                     // Shows status of record verification
	TopicType        *string   `bun:"topic_type,type:varchar(10)"`                               // Type of Topic (TABLE -  DW -  TAB -  WINDOW)
