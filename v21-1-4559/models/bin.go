...
type Bin struct {
	...
	DateLastCounted      *mssql.DateTime1 `bun:"date_last_counted,type:datetime"`                           // When was the inventory at this location last counted?
	...
	DateLastValidated    *mssql.DateTime1 `bun:"date_last_validated,type:datetime"`                         // Last time BIN was validated
