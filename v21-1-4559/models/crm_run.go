...
type CrmRun struct {
	...
	LastHardTouchDate          *mssql.DateTime1 `bun:"last_hard_touch_date,type:datetime"`                           // The last hard-touch date for this customer.
	...
	DateLastInvoiced           *mssql.DateTime1 `bun:"date_last_invoiced,type:datetime"`                             // Date the customer was last invoiced
