...
type PricePage struct {
	...
	DateLastSentOn832          *time.Time `bun:"date_last_sent_on_832,type:datetime"`                     // Will indicate the last time a pages detail was transmitted on an 832.
	DatePageDeleted            *time.Time `bun:"date_page_deleted,type:datetime"`                         // Will indicate the date a page was deleted.
