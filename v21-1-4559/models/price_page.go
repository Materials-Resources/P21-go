...
type PricePage struct {
	...
	MfgClassId                 *string          `bun:"mfg_class_id,type:varchar(255)"`                // Manufacturing Class ID (used for Supplier/Mfg Class type pages only)
	SupplierId                 *float64         `bun:"supplier_id,type:decimal(19,0)"`                // Supplier ID (used for Supplier, Supplier/Discount Group, and Supplier/Mfg Class type pages only)
	ProductGroupId             *string          `bun:"product_group_id,type:varchar(8)"`              // Product Group ID (used for Product Group type pages only)
	DiscountGroupId            *string          `bun:"discount_group_id,type:varchar(8)"`             // Discount Group ID (used for Discount Group and Supplier/Discount Group type pages only)
	MajorGroupId               *string          `bun:"major_group_id,type:varchar(8)"`                // Major Group ID (used only when totaling method is Major Group)
	Description                *string          `bun:"description,type:varchar(255)"`                 // User-defined description of the pricing page
	PricingMethodCd            int16            `bun:"pricing_method_cd,type:smallint"`               // Pricing Method (Source, Price, None)
	SourcePriceCd              *int16           `bun:"source_price_cd,type:smallint"`                 // Stores the Source Price when Pricing Method is set to Source
	Price                      *float64         `bun:"price,type:decimal(19,9)"`                      // Stores the Price when Pricing Method is set to Price
	EffectiveDate              mssql.DateTime1  `bun:"effective_date,type:datetime"`                  // Date this pricing page takes effect
	ExpirationDate             mssql.DateTime1  `bun:"expiration_date,type:datetime"`                 // Date after which this pricing page is no longer in effect
	ContractNumber             *string          `bun:"contract_number,type:varchar(40)"`              // User-defined contract number
	...
	OtherCost1                 *float64         `bun:"other_cost1,type:decimal(19,9)"`                // Other Cost value for break 1
	OtherCost2                 *float64         `bun:"other_cost2,type:decimal(19,9)"`                // Other Cost value for break 2
	OtherCost3                 *float64         `bun:"other_cost3,type:decimal(19,9)"`                // Other Cost value for break 3
	OtherCost4                 *float64         `bun:"other_cost4,type:decimal(19,9)"`                // Other Cost value for break 4
	OtherCost5                 *float64         `bun:"other_cost5,type:decimal(19,9)"`                // Other Cost value for break 5
	OtherCost6                 *float64         `bun:"other_cost6,type:decimal(19,9)"`                // Other Cost value for break 6
	OtherCost7                 *float64         `bun:"other_cost7,type:decimal(19,9)"`                // Other Cost value for break 7
	OtherCost8                 *float64         `bun:"other_cost8,type:decimal(19,9)"`                // Other Cost value for break 8
	OtherCost9                 *float64         `bun:"other_cost9,type:decimal(19,9)"`                // Other Cost value for break 9
	OtherCost10                *float64         `bun:"other_cost10,type:decimal(19,9)"`               // Other Cost value for break 10
	OtherCost11                *float64         `bun:"other_cost11,type:decimal(19,9)"`               // Other Cost value for break 11
	OtherCost12                *float64         `bun:"other_cost12,type:decimal(19,9)"`               // Other Cost value for break 12
	OtherCost13                *float64         `bun:"other_cost13,type:decimal(19,9)"`               // Other Cost value for break 13
	OtherCost14                *float64         `bun:"other_cost14,type:decimal(19,9)"`               // Other Cost value for break 14
	OtherCost15                *float64         `bun:"other_cost15,type:decimal(19,9)"`               // Other Cost value for break 15
	Uom1                       *string          `bun:"uom1,type:varchar(8)"`                          // UOM for break 1
	Uom2                       *string          `bun:"uom2,type:varchar(8)"`                          // UOM for break 2
	Uom3                       *string          `bun:"uom3,type:varchar(8)"`                          // UOM for break 3
	Uom4                       *string          `bun:"uom4,type:varchar(8)"`                          // UOM for break 4
	Uom5                       *string          `bun:"uom5,type:varchar(8)"`                          // UOM for break 5
	Uom6                       *string          `bun:"uom6,type:varchar(8)"`                          // UOM for break 6
	Uom7                       *string          `bun:"uom7,type:varchar(8)"`                          // UOM for break 7
	Uom8                       *string          `bun:"uom8,type:varchar(8)"`                          // UOM for break 8
	Uom9                       *string          `bun:"uom9,type:varchar(8)"`                          // UOM for break 9
	Uom10                      *string          `bun:"uom10,type:varchar(8)"`                         // UOM for break 10
	Uom11                      *string          `bun:"uom11,type:varchar(8)"`                         // UOM for break 11
	Uom12                      *string          `bun:"uom12,type:varchar(8)"`                         // UOM for break 12
	Uom13                      *string          `bun:"uom13,type:varchar(8)"`                         // UOM for break 13
	Uom14                      *string          `bun:"uom14,type:varchar(8)"`                         // UOM for break 14
	...
	OtherCostTypeCd            *int16           `bun:"other_cost_type_cd,type:smallint"`              // Indicates the type of the Other Cost value (Order, Value, etc.)
	OtherCostValue             *float64         `bun:"other_cost_value,type:decimal(19,9)"`           // Stores a specific Other Cost value when other_cost_type_cd is set to value
	OtherCostSourceCd          *int16           `bun:"other_cost_source_cd,type:smallint"`            // Stores the Other Cost source when other_cost_type_cd is set to source
	CostCalculationMethodCd    *int16           `bun:"cost_calculation_method_cd,type:smallint"`      // Stores the calulation method related to Other Cost (multiplier, difference, etc.)
	CostCalculationValue       *float64         `bun:"cost_calculation_value,type:decimal(19,4)"`     // Stores the calculation value related to the Other Cost calculation method
	CommissionCostTypeCd       *int16           `bun:"commission_cost_type_cd,type:smallint"`         // Indicates the type of  the Commission Cost value (Order, Value, etc.)
	CommissionCostValue        *float64         `bun:"commission_cost_value,type:decimal(19,9)"`      // Stores a specific Commission Cost value when commission_cost_type_cd is set to value
	CommissionCostSourceCd     *int16           `bun:"commission_cost_source_cd,type:smallint"`       // Stores the Commission Cost Source when commission_cost_type_cd is set to source
	CommissionCostCalcMethodCd *int16           `bun:"commission_cost_calc_method_cd,type:smallint"`  // Stores the calculation method related to Commission Cost (multiplier, difference, etc.)
	CommissionCostCalcValue    *float64         `bun:"commission_cost_calc_value,type:decimal(19,4)"` // Stores the calculation value related to the Commission Cost calculation method
	PricePageId                *string          `bun:"price_page_id,type:varchar(20)"`                // User-defined Price Page identifier
	CustomerId                 *float64         `bun:"customer_id,type:decimal(19,0)"`                // Customer ID - used for Customer Part Number type pages only
	CustomerPartNo             *string          `bun:"customer_part_no,type:varchar(40)"`             // Customer Part Number - used for Customer Part Number type pages only
	...
	CurrencyId                 *float64         `bun:"currency_id,type:decimal(19,0)"`                          // Determines the price page currency
	ValuesCurrencyId           *float64         `bun:"values_currency_id,type:decimal(19,0)"`                   // Determines the price page values currency
	...
	DateLastSentOn832          *mssql.DateTime1 `bun:"date_last_sent_on_832,type:datetime"`                     // Will indicate the last time a pages detail was transmitted on an 832.
	DatePageDeleted            *mssql.DateTime1 `bun:"date_page_deleted,type:datetime"`                         // Will indicate the date a page was deleted.
	PriceFamilyUid             *int32           `bun:"price_family_uid,type:int"`                               // UID for pricing by price family
	PeerPricePageUid           *int32           `bun:"peer_price_page_uid,type:int"`                            // Indicates the parent of this price page - if any.
	ContractLineUid            *int32           `bun:"contract_line_uid,type:int"`                              // Indicates the contract line that created this price page.
	...
	RoundToNextDollar          *int16           `bun:"round_to_next_dollar,type:tinyint"`                       // Custom - Used for special rounding (next 1 or 9  dollar)
	...
	FreightFactorSourceCd      *int32           `bun:"freight_factor_source_cd,type:int"`                       // Source value to multiply freight factor by
	NoChargeFlag               *string          `bun:"no_charge_flag,type:char(1)"`                             // Custom column to indicate no price charged for the page
	...
	RebateMargin               *float64         `bun:"rebate_margin,type:decimal(19,9)"`                        // The percentage amout after the rebate of the total invoiced amount
	UpperMarginVariance        *float64         `bun:"upper_margin_variance,type:decimal(19,9)"`                // Allowed percentage to exceed the rebate margin
	LowerMarginVariance        *float64         `bun:"lower_margin_variance,type:decimal(19,9)"`                // Allowed percentage to be bellow the rebate margin
	ExcludeOrderLevelDiscFlag  *string          `bun:"exclude_order_level_disc_flag,type:char(1)"`
	RolledItemPricingTypeCd    *int32           `bun:"rolled_item_pricing_type_cd,type:int"` // Custom: Indicates the pricing type for rolled items.  Full Roll, Partial Roll, or Non-Roll.
}
