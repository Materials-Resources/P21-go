...
type PopupField struct {
	...
	Header                           *string         `bun:"header,type:varchar(50)"`                                      // Header field name on window
	FieldType                        int16           `bun:"field_type,type:smallint"`                                     // Type
	FieldWidth                       int16           `bun:"field_width,type:smallint"`                                    // Field width
	Mask                             *string         `bun:"mask,type:varchar(99)"`                                        // Field mask
	ReturnTo                         *string         `bun:"return_to,type:varchar(50)"`                                   // Return to
	OnGrid                           *bool           `bun:"on_grid,type:bit"`                                             // Is field showed in grid
	AsParameter                      *bool           `bun:"as_parameter,type:bit"`                                        // Filled with parameter value
	Filter                           *bool           `bun:"filter,type:bit"`                                              // Can use this filed to filter
	Enabled                          *bool           `bun:"enabled,type:bit"`                                             // Is enabled
	PopupToShow                      *string         `bun:"popup_to_show,type:varchar(50)"`                               // Has secondary popup
	...
	ParameterCodeGroup               *string         `bun:"parameter_code_group,type:varchar(255)"`                       // Code used by the parameter
	ParameterDefaultValue            *string         `bun:"parameter_default_value,type:varchar(255)"`                    // Default value of the parameter
	ParameterHeader                  *string         `bun:"parameter_header,type:varchar(50)"`                            // Header of the parameter control
	ParameterWidth                   *int32          `bun:"parameter_width,type:int"`                                     // Width of the parameter control
	ParameterEnabled                 *bool           `bun:"parameter_enabled,type:bit"`                                   // If the parameter control is enabled
	ParameterFilter                  *bool           `bun:"parameter_filter,type:bit"`                                    // If the parameter control should apply filters
	ParameterType                    *int32          `bun:"parameter_type,type:int"`                                      // The type of the parameter control
	ParameterLocationX               *int32          `bun:"parameter_location_x,type:int"`                                // X axis of the location of a parameter
	ParameterLocationY               *int32          `bun:"parameter_location_y,type:int"`                                // Y axis of the location of a parameter
	Rank                             *int32          `bun:"rank,type:int"`                                                // Determines the rank value of the column
	ParameterHiddenCondition         *string         `bun:"parameter_hidden_condition,type:varchar(1000)"`                // Sets a condition on which a parameter controls must be hidden
	AliasDefinition                  *string         `bun:"alias_definition,type:varchar(5000)"`                          // The definition of a column alias associated to this popup field
	FieldExpression                  *string         `bun:"field_expression,type:varchar(5000)"`                          // Stores the expression of a column  used in run time
	DataType                         *string         `bun:"data_type,type:varchar(255)"`                                  // Type of the data of the column that is related to the field.
