...
type ProcessXTransaction struct {
	...
	BeginDate                      mssql.DateTime1  `bun:"begin_date,type:datetime"`                                      // The date to begin posting this voucher.
	EstimatedDate                  mssql.DateTime1  `bun:"estimated_date,type:datetime"`                                  // What was the original estimate for a completion date for this relationship between a process and a transaction?
	ExpectedDate                   mssql.DateTime1  `bun:"expected_date,type:datetime"`                                   // What is the expected date that this relatinship between a process and a transaction should be completed?
	...
	ExtendedDescription            *string          `bun:"extended_description,type:text"`                                // Extended description of the process.
	ProcessCd                      *string          `bun:"process_cd,type:varchar(255)"`                                  // Code used to identify this process.
	ProcessName                    *string          `bun:"process_name,type:varchar(255)"`                                // Name of the process.
	ProcessDesc                    *string          `bun:"process_desc,type:varchar(255)"`                                // Extended description for this process.
	...
	CompletedDate                  *mssql.DateTime1 `bun:"completed_date,type:datetime"`                                  // Completion date for process trasaction
	...
	CountryOfOrigin                *string          `bun:"country_of_origin,type:varchar(255)"`                           // Custom column to store finished item's country of origin in Secondary Processing Window
	ProcessPoWithoutAllocationFlag *string          `bun:"process_po_without_allocation_flag,type:char(1)"`               // Allows the user to process first po without allocating to the transaction
	QwoNo                          *string          `bun:"qwo_no,type:varchar(255)"`                                      // QWO number. Used to track QA/QC receipt processes in both P21 and WA Solution
}
