...
type Supplier struct {
	...
	DateOfLastReview                *time.Time `bun:"date_of_last_review,type:datetime"`                         // When was the last time GPOR was ran for this supplier, defining requirements?
	...
	DefaultPriceExpirationDate      *time.Time `bun:"default_price_expiration_date,type:datetime"`                    // Default price expiration date for all items for this supplier
