...
type InvoiceLine struct {
	...
	SentToCarrierDate           *mssql.DateTime1 `bun:"sent_to_carrier_date,type:datetime"`               // Date that this line was exported with Carrier Claim export.
	...
	ClaimStartDate              *mssql.DateTime1 `bun:"claim_start_date,type:datetime"`                  // Claim Start Date
	ClaimEndDate                *mssql.DateTime1 `bun:"claim_end_date,type:datetime"`                    // Claim End Date
