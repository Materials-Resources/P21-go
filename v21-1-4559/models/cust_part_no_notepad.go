...
type CustPartNoNotepad struct {
	...
	ActivationDate   mssql.DateTime1 `bun:"activation_date,type:datetime"`                             // The date when the notepad record becomes activated.
	ExpirationDate   mssql.DateTime1 `bun:"expiration_date,type:datetime"`                             // The date when the notepad record expires.
	EntryDate        mssql.DateTime1 `bun:"entry_date,type:datetime"`                                  // The date when this note was entered.
