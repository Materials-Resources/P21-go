...
type Payments struct {
	...
	StatementClearedDate       *time.Time `bun:"statement_cleared_date,type:datetime"`                            // Date in which the check was cleared
	...
	CheckMailedDate            *time.Time `bun:"check_mailed_date,type:datetime"`                                 // Custom Feature 28424: Date check was mailed to vendor
	...
	VoidDate                   *time.Time `bun:"void_date,type:datetime"`                                         // Date Check was Voided
