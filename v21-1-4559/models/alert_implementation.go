...
type AlertImplementation struct {
	...
	ActivationDate          mssql.DateTime1  `bun:"activation_date,type:datetime"`                      // The date this note will be activated.
	ExpirationDate          mssql.DateTime1  `bun:"expiration_date,type:datetime"`                      // The date this note will expire.
	...
	WhereClause             *string          `bun:"where_clause,type:text"`                             // The where clause that will be used for a specific alert.
	...
	NextExecutionStartPoint *mssql.DateTime1 `bun:"next_execution_start_point,type:datetime"`           // Indicates the next time this alert will start.
	...
	LastExecutionError      *int32           `bun:"last_execution_error,type:int"`                      // Executing a string does not return a value.
