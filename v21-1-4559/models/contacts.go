...
type Contacts struct {
	...
	Birthday                  *mssql.DateTime1 `bun:"birthday,type:datetime"`                                          // What is the birthday of this contact?
	Anniversary               *mssql.DateTime1 `bun:"anniversary,type:datetime"`                                       // What is the anniversary date of this contact?
	...
	DateDirectFaxLastModified *mssql.DateTime1 `bun:"date_direct_fax_last_modified,type:datetime,default:(getdate())"` // Customer (F45503): date the direct_fax column was last modified.  Populated via a trigger.
