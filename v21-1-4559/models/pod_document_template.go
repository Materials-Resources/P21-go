...
type PodDocumentTemplate struct {
	...
	DocumentTemplate       *string   `bun:"document_template,type:text"`                                  // XML document template
	...
	DocumentVersion        *string   `bun:"document_version,type:varchar(255)"`                           // Tiebreaker if multiple version of the same document id are present
}
