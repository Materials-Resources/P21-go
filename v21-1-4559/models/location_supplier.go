...
type LocationSupplier struct {
	...
	DateOfLastReview        *mssql.DateTime1 `bun:"date_of_last_review,type:datetime"`                         // Last time GPOR was ran for this location/supplier combo to determine requirements.
