...
type OeHdrSalesrep struct {
	...
	DatePaid                   *mssql.DateTime1 `bun:"date_paid,type:datetime"`                                       // Date the commission was paid.
	PrimarySalesrep            *string          `bun:"primary_salesrep,type:char(1)"`                                 // Indicates whether this is the primary salesrep for this order.
	...
	CommissionOverridePercent  *float64         `bun:"commission_override_percent,type:decimal(19,9)"`                // Percent of the sales amount to be used to override the normal commission calculation for the associated salesrep. If field is left NULL, commission will be calculated using normal commission rules.
}
