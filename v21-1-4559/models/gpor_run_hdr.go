...
type GporRunHdr struct {
	...
	LookAheadDate            *mssql.DateTime1 `bun:"look_ahead_date,type:datetime"`
	...
	MinDynamicLookAheadDate  *mssql.DateTime1 `bun:"min_dynamic_look_ahead_date,type:datetime"`             // The minimum look ahead date to use when using the dynamic look ahead date option
