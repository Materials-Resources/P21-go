...
type OePickTicket struct {
	...
	PrintDate                *mssql.DateTime1 `bun:"print_date,type:datetime"`                                      // The date the pick ticket was printed.
	...
	ShipDate                 *mssql.DateTime1 `bun:"ship_date,type:datetime"`                                       // When was this order shipped?
	...
	PackingListPrintDate     *mssql.DateTime1 `bun:"packing_list_print_date,type:datetime"`                   // Custom (F51767): timestamp for when the packing list associated with this pick ticket was printed.
	...
	SentToAttDate            *mssql.DateTime1 `bun:"sent_to_att_date,type:datetime"`                          // Date when the pick ticket was last exported.
