...
type InvMast struct {
	...
	DateInactive                  *mssql.DateTime1 `bun:"date_inactive,type:datetime"`                               // date item was made inactive, or no longer available
	DateReactive                  *mssql.DateTime1 `bun:"date_reactive,type:datetime"`                               // This column is unused.
	...
	LastPricingServiceDate        *mssql.DateTime1 `bun:"last_pricing_service_date,type:datetime"`                     // Specifies the last time this item was updated by Pricing Service
	...
	DiscontinuedDate              *mssql.DateTime1 `bun:"discontinued_date,type:datetime"`                             // Custom column to indicate the item is discontinued
