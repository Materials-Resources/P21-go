...
type AccntGroupMx struct {
	...
	GroupDescription *string   `bun:"group_description,type:varchar(255)"`                          // Long group description. Not null values defined by SAT at this moment.
	...
	Level            *int32    `bun:"level,type:int"`                                               // Level
}
