...
type BankAccounts struct {
	...
	BeginReconcileDate        *mssql.DateTime1 `bun:"begin_reconcile_date,type:datetime"`                        // The date that reconciliation functionality was turned on for the bank.
	...
	AchFileIdModifierDate     *mssql.DateTime1 `bun:"ach_file_id_modifier_date,type:datetime"`                   // Last date that the file_id_modifier was updated. Lets us know if we have to use it or start over.
