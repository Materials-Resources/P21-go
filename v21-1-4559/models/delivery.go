...
type Delivery struct {
	...
	BeginShipmentDate        *time.Time `bun:"begin_shipment_date,type:datetime"`                       // Date Time that the delivery started. Time that the driver clocked in at the first stop.
	EndShipmentDate          *time.Time `bun:"end_shipment_date,type:datetime"`                         // Date Time that the delivery ended. Time that the driver clocked out at the last stop.
