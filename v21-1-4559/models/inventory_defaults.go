...
type InventoryDefaults struct {
	...
	RevenueAccount            *string   `bun:"revenue_account,type:varchar(32)"`                          // Revenue Account default for an item at this location
	CosAccount                *string   `bun:"cos_account,type:varchar(32)"`                              // COS Account default for an item at this location
	...
	SafetyStock               *float64  `bun:"safety_stock,type:decimal(4,0)"`                            // Default safety stock.
	...
	ProductGroupId            *string   `bun:"product_group_id,type:varchar(8)"`                          // Default product group for an item at this location.
	...
	SupplierId                *float64  `bun:"supplier_id,type:decimal(19,0)"`                            // What supplier is participating in this relationship?
	...
	DefaultSalesDiscountGroup *string   `bun:"default_sales_discount_group,type:varchar(8)"`              // Default sales discount group.
	DefaultPurchaseDiscGroup  *string   `bun:"default_purchase_disc_group,type:varchar(8)"`               // Default purchase discount group.
	TaxGroupId                *string   `bun:"tax_group_id,type:varchar(10)"`                             // Indicates the tax group identification.
	DefaultBin                *string   `bun:"default_bin,type:varchar(10)"`                              // Used as the default bin for an item created on the
	...
	ReceiptProcessUid         *int32    `bun:"receipt_process_uid,type:int"`                              // Identifies the pre-defined rounting for items that undergo secondary processing upon receipt
	...
	ServiceSupplierId         *float64  `bun:"service_supplier_id,type:decimal(19,0)"`                    // Default Supplier ID used when creating an on-the-fly service item at this location.
	ServiceDivisionId         *float64  `bun:"service_division_id,type:decimal(19,0)"`                    // Default Division ID used when creating an on-the-fly service item at this location.
	ServiceProductGroupId     *string   `bun:"service_product_group_id,type:varchar(8)"`                  // Default Product Group ID used when creating an on-the-fly service item at this location.
	DefaultPriceFamilyUid     *int32    `bun:"default_price_family_uid,type:int"`                         // The default price family identifier that pertains to this location and company - unique identifier for price_family table.
	...
	ManufacturingClassId      *string   `bun:"manufacturing_class_id,type:varchar(255)"`                  // Default manufacturing class ID
	CommissionClassId         *string   `bun:"commission_class_id,type:varchar(255)"`                     // Default commission class ID
	ClassId1                  *string   `bun:"class_id1,type:varchar(255)"`                               // Default item class 1
	ClassId2                  *string   `bun:"class_id2,type:varchar(255)"`                               // Default item class 2
	ClassId3                  *string   `bun:"class_id3,type:varchar(255)"`                               // Default item class 3
	ClassId4                  *string   `bun:"class_id4,type:varchar(255)"`                               // Default item class 4
	ClassId5                  *string   `bun:"class_id5,type:varchar(255)"`                               // Default item class 5
	StandardCostMultiplier    *float64  `bun:"standard_cost_multiplier,type:decimal(19,9)"`               // Default standard cost multiplier
	SpecialCostMultiplier     *float64  `bun:"special_cost_multiplier,type:decimal(19,9)"`                // Default special cost multiplier
	SupplierCostMultiplier    *float64  `bun:"supplier_cost_multiplier,type:decimal(19,9)"`               // Default supplier cost multiplier
	PricingServiceOption      *int32    `bun:"pricing_service_option,type:int"`                           // Default pricing service option
	OverrideProfitLimitsFlag  *string   `bun:"override_profit_limits_flag,type:char(1)"`                  // Flag that will be the default for wether or not profit limits will come from this item
	MinimumOrderProfit        *float64  `bun:"minimum_order_profit,type:decimal(19,9)"`                   // This will be the minimum order profit percentage for this item
	MaximumOrderProfit        *float64  `bun:"maximum_order_profit,type:decimal(19,9)"`                   // This will be the maximum order profit percentage for this item
	RmaRevenueAccountNo       *string   `bun:"rma_revenue_account_no,type:varchar(32)"`                   // Default value for rma revenu account.
	...
	MasterBinUid              *int32    `bun:"master_bin_uid,type:int"`                                   // Indicates master bin for this location default.
	BinTypeUid                *int32    `bun:"bin_type_uid,type:int"`                                     // Indicates bin type for this location default.
	DrpItemFlag               *string   `bun:"drp_item_flag,type:char(1)"`                                // Save the default value to set for same column name while creating new items.
	PurchaseClass             *string   `bun:"purchase_class,type:varchar(8)"`                            // purchase_class
