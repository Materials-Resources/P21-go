...
type CashDrawerHistory struct {
	...
	DateOpened              mssql.DateTime1  `bun:"date_opened,type:datetime"`                                 // Date drawer is opened
	DateClosed              *mssql.DateTime1 `bun:"date_closed,type:datetime"`                                 // Date drawer is closed
