...
type SystemParameters struct {
	...
	HelpDirectory               *string         `bun:"help_directory,type:varchar(255)"`
	NoOfRetries                 *float64        `bun:"no_of_retries,type:decimal(19,0)"`
	SetUpMode                   *string         `bun:"set_up_mode,type:char(1)"`
	InventoryModuleInstalled    *string         `bun:"inventory_module_installed,type:char(1)"`
	UsedInUs                    *string         `bun:"used_in_us,type:char(1)"`
	ForeignCurrency             *string         `bun:"foreign_currency,type:char(1)"`
	...
	CurrencyMask                *string         `bun:"currency_mask,type:varchar(50)"`
	NumberOfSigs                string          `bun:"number_of_sigs,type:char(1)"`
	Sig1Path                    *string         `bun:"sig1_path,type:varchar(255)"`
	Sig2Path                    *string         `bun:"sig2_path,type:varchar(255)"`
	...
	AmountReqTwoSigs            *float64        `bun:"amount_req_two_sigs,type:decimal(19,4)"`
	ValidateCustContactsOnOe    string          `bun:"validate_cust_contacts_on_oe,type:char(1)"`
	DefaultBackorderQty         *string         `bun:"default_backorder_qty,type:char(1)"`
	...
	DatabaseVersion             *string         `bun:"database_version,type:varchar(8)"`
	FireGlTrigger               *string         `bun:"fire_gl_trigger,type:char(1)"`
	LogoPath                    *string         `bun:"logo_path,type:varchar(255)"`
	NoOfCycleDays               *int32          `bun:"no_of_cycle_days,type:int"`
	UseBillingAddress           *string         `bun:"use_billing_address,type:char(1)"`
	UsePayableGroups            *string         `bun:"use_payable_groups,type:char(1)"`
	UseReceivableGroups         *string         `bun:"use_receivable_groups,type:char(1)"`
	CommissionModuleInstalled   *string         `bun:"commission_module_installed,type:char(1)"`
	UseEnterKey                 *string         `bun:"use_enter_key,type:char(1)"`
	CharacterSensitivePopups    *string         `bun:"character_sensitive_popups,type:char(1)"`
	DefaultPreviousPeriodYear   *string         `bun:"default_previous_period_year,type:char(1)"`
	DisplayUpdateWasSuccessful  *string         `bun:"display_update_was_successful,type:char(1)"`
	BuyerOnlyToPlacePo          *string         `bun:"buyer_only_to_place_po,type:char(1)"`
	UsingApprovals              *string         `bun:"using_approvals,type:char(1)"`
	SalesPricingMethod          string          `bun:"sales_pricing_method,type:varchar(2)"`
	TabSecActive                *string         `bun:"tab_sec_active,type:char(1)"`
	BranchSecActive             *string         `bun:"branch_sec_active,type:char(1)"`
	Reserved1                   *float64        `bun:"reserved1,type:decimal(1,0)"`
	JobIdMask                   *string         `bun:"job_id_mask,type:varchar(64)"`
	CharacterSpecificPopups     *string         `bun:"character_specific_popups,type:char(1)"`
	...
	MinCharForCharSpecific      *float64        `bun:"min_char_for_char_specific,type:decimal(2,0)"`
	KeystrokeForPopups          *string         `bun:"keystroke_for_popups,type:varchar(10)"`
	KeystrokeForNewLineItem     *string         `bun:"keystroke_for_new_line_item,type:varchar(10)"`
	MailModuleInstalled         *string         `bun:"mail_module_installed,type:char(1)"`
	...
	CrystalDirectory            *string         `bun:"crystal_directory,type:varchar(255)"`
	EnableFax                   string          `bun:"enable_fax,type:char(1),default:('N')"`
	FaxFilePath                 *string         `bun:"fax_file_path,type:varchar(50)"`
