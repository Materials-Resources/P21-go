...
type DeliveryPickTicket struct {
	...
	ReconciliationFlag    *string   `bun:"reconciliation_flag,type:char(1)"`         // The driver has entered an edit in the quantity delivered or acceptance of the delivery.
	Notes                 *string   `bun:"notes,type:varchar(255)"`                  // Notes the driver took about this pick ticket during delviery.
