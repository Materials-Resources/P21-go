...
type Area struct {
	...
	JournalEntry               *string `bun:"journal_entry,type:char(1)"`                               // Is the note area an available display area for a journal_entry note?
	...
	Invoice                    *string `bun:"invoice,type:char(1)"`                                     // This column will indicate which areas in the system display invoice notes.
