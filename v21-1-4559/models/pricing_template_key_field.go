...
type PricingTemplateKeyField struct {
	...
	CompanyId                  *string   `bun:"company_id,type:varchar(8)"`                                   // The company_id when using the Product Group key field
	...
	NumberOfCharacters         *int32    `bun:"number_of_characters,type:int"`                                // Indiciates the number of characters to be appended to the Item ID.
	ItemPrefixSuffix           *string   `bun:"item_prefix_suffix,type:varchar(255)"`                         // The value to be appended to the Item ID.
	...
	SecondaryKeyFieldId        *string   `bun:"secondary_key_field_id,type:varchar(255)"`                     // Value of the secondary key type
	SecondaryKeyFieldDesc      *string   `bun:"secondary_key_field_desc,type:varchar(255)"`                   // Description of the secondary key value
}
