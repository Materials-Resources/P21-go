...
type OeLinePanel struct {
	...
	OeLinePanelUid     int32     `bun:"oe_line_panel_uid,type:int,autoincrement,identity,pk"`         // Unique identifier for oe_line_panel
	DefaultName        *string   `bun:"default_name,type:varchar(255)"`                               // Default name for this panel
	...
	SystemSettingName  *string   `bun:"system_setting_name,type:varchar(128)"`                        // Name of system setting associated with this panel.
