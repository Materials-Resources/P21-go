...
type VendorNotepad struct {
	...
	ActivationDate   mssql.DateTime1 `bun:"activation_date,type:datetime"`                                // date of activation
	ExpirationDate   mssql.DateTime1 `bun:"expiration_date,type:datetime"`                                // date of expiration
	EntryDate        mssql.DateTime1 `bun:"entry_date,type:datetime"`                                     // date entered
