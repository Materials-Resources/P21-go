...
type Language struct {
	...
	CrystalReportsFolder *string   `bun:"crystal_reports_folder,type:char(255)"` // Folder containing Crystal reports for this language
	IsoCode              *string   `bun:"iso_code,type:varchar(5)"`              // ISO code for the language, consisting of a language code (from ISO-639) and an optional two-letter country code (from ISO-3166)
}
