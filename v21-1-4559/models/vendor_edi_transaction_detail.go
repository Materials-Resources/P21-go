...
type VendorEdiTransactionDetail struct {
	...
	DateCreated             mssql.DateTime1 `bun:"date_created,type:datetime,default:(getdate())"` // date created
	CreatedBy               string          `bun:"created_by,type:varchar(255),default:(suser_sname())"`
	DateLastModified        mssql.DateTime1 `bun:"date_last_modified,type:datetime,default:(getdate())"`      // datetime last modified
