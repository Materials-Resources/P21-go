...
type QuoteHdr struct {
	...
	Date843Sent      *mssql.DateTime1 `bun:"date_843_sent,type:datetime"`                                   // Date when last EDI 843 was sent
	ExpirationDate   *mssql.DateTime1 `bun:"expiration_date,type:datetime"`                                 // Date quote expires
}
