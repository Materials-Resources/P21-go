...
type CommissionRule struct {
	...
	EffectiveDate              mssql.DateTime1 `bun:"effective_date,type:datetime"`                               // When does this purchase pricing page go into effec
	...
	ProductGroupId             *string         `bun:"product_group_id,type:varchar(8)"`                           // Product group associated with this rule
	SalesDiscountGroupId       *string         `bun:"sales_discount_group_id,type:varchar(8)"`                    // Discount group this rule groups by (filled in when
	SupplierId                 *float64        `bun:"supplier_id,type:decimal(19,0)"`                             // What supplier supplies material for this stage?
	ItemCommissionClass        *string         `bun:"item_commission_class,type:varchar(8)"`                      // Item Commission Class this rule groups by (filled
	...
	CustomerId                 *float64        `bun:"customer_id,type:decimal(19,0)"`                             // Customer ID associated with this rule.
	ManufacturingClassId       *string         `bun:"manufacturing_class_id,type:varchar(255)"`                   // Manufacturing Class ID associated with this rule.
	InvMastUid                 *int32          `bun:"inv_mast_uid,type:int"`                                      // Unique Item ID associated with this rule.
	CustomerPartNumber         *string         `bun:"customer_part_number,type:varchar(40)"`                      // Customer Part No associated with this rule.
	FreightCodeUid             *int32          `bun:"freight_code_uid,type:int"`                                  // Freight code associated with this rule.
	SalesLocationId            *float64        `bun:"sales_location_id,type:decimal(19,0)"`                       // Sales Location ID associated with this rule.
	PrimarySupplierId          *float64        `bun:"primary_supplier_id,type:decimal(19,0)"`                     // Primary Supplier ID associated with this rule.
	...
	CustomerDays               *int32          `bun:"customer_days,type:int"`                                     // The number of days that this rule is valid from when the first order with this customer was entered.
	ItemDays                   *int32          `bun:"item_days,type:int"`                                         // The number of days this rule is valid from when the first order with this item was entered.
	...
	LineThresholdType          *string         `bun:"line_threshold_type,type:char(1)"`                           // The type of threshold (percent or dollar).
	...
	TerritoryUid               *int32          `bun:"territory_uid,type:int"`                                     // The territory UID for which this commission rule applies.
	...
	Class4Id                   *string         `bun:"class_4id,type:varchar(255)"`                                // Field used with the Order Class 4 Group By option in Commission Rules to determine if the salesrep on a particular sales order is eligible for commission.
	ApplyToManualArOnlyFlag    *string         `bun:"apply_to_manual_ar_only_flag,type:char(1)"`                  // apply_to_manual_ar_only_flag
}
