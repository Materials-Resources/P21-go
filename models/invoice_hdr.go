...
type InvoiceHdr struct {
	...
	InvoiceDate                mssql.DateTime1  `bun:"invoice_date,type:datetime"`                                // Indicates the date on the invoice.
	...
	ShipDate                   *mssql.DateTime1 `bun:"ship_date,type:datetime"`                                   // Shipping date for this invoice.
	...
	DatePaid                   *mssql.DateTime1 `bun:"date_paid,type:datetime"`                                   // Indicates the date the invoice was paid.
	PrintFlag                  *string          `bun:"print_flag,type:char(1)"`                                   // Indicates whether the invoice was printed.
	PrintDate                  *mssql.DateTime1 `bun:"print_date,type:datetime"`                                  // The date the invoice was printed.
	...
	PrintedDate                *mssql.DateTime1 `bun:"printed_date,type:datetime"`                                // The date the invoice was printed.
	...
	FcThruDate                 *mssql.DateTime1 `bun:"fc_thru_date,type:datetime"`                                // The last time a finance charge invoice was generated for a late invoice.  The Finance Charge Through Date is used if an additional invoice is generated for the same late invoice.
	...
	SentToCarrierDate          *mssql.DateTime1 `bun:"sent_to_carrier_date,type:datetime"`                 // Date that this invoice was exported to Carrier.
	...
	EftExportedDate            *mssql.DateTime1 `bun:"eft_exported_date,type:datetime"`                      // Date that this invoice was exported for ACH payment to the bank.
