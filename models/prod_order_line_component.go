...
type ProdOrderLineComponent struct {
	...
	RequiredDate              *mssql.DateTime1 `bun:"required_date,type:datetime"`                           // The date in which this production order line component is required.
	ExpediteDate              *mssql.DateTime1 `bun:"expedite_date,type:datetime"`                           // The date in which this production order line component needs to be expedited
	...
	OriginalCompletionDate    *mssql.DateTime1 `bun:"original_completion_date,type:datetime"`                // Original expected completion date
	CompletionDate            *mssql.DateTime1 `bun:"completion_date,type:datetime"`                         // Current expected completion date
