...
type ActivityTrans struct {
	...
	EntryDate             mssql.DateTime1  `bun:"entry_date,type:datetime"`                                  // Date indicating when this note was entered.
	...
	CompletedDate         *mssql.DateTime1 `bun:"completed_date,type:datetime"`                              // Date the activity was completed -  or if the complet
	...
	TargetCompleteDate    mssql.DateTime1  `bun:"target_complete_date,type:datetime"`                        // Date by which we would like this task completed
	...
	DateLastSynched       *mssql.DateTime1 `bun:"date_last_synched,type:datetime"`                           // Indicates the date/time this record was last synched with outlook
	...
	StartDate             *mssql.DateTime1 `bun:"start_date,type:datetime"`                                  // Start Date for the task
}
