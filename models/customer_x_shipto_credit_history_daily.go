...
type CustomerXShiptoCreditHistoryDaily struct {
	...
	DateInvoiced                      mssql.DateTime1 `bun:"date_invoiced,type:datetime"`                                                // Date of the invoice/payment
	...
	AvgFastSlowDaysAmountPaid         *float64        `bun:"avg_fast_slow_days_amount_paid,type:decimal(19,4)"`                          // avg_fast_slow_days_amount_paid
