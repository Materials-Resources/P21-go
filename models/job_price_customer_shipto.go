...
type JobPriceCustomerShipto struct {
	...
	ActivationDate               *mssql.DateTime1 `bun:"activation_date,type:datetime"`                                // Date of activation for the record
	ExpirationDate               *mssql.DateTime1 `bun:"expiration_date,type:datetime"`                                // Date of expiration for the record.
