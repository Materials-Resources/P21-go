...
type Gl struct {
	...
	TransactionDate            mssql.DateTime1  `bun:"transaction_date,type:datetime"`                                // Date of the transaction.
	...
	DateApprovedFromUnapproved *mssql.DateTime1 `bun:"date_approved_from_unapproved,type:datetime"`                   // Indicates when the transaction became approved.
