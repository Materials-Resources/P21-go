...
type Note struct {
	...
	ActivationDate          mssql.DateTime1 `bun:"activation_date,type:datetime"`                                // Date that the note begins to be viewable
	ExpirationDate          mssql.DateTime1 `bun:"expiration_date,type:datetime"`                                // Date when the note ends being viewable
	EntryDate               mssql.DateTime1 `bun:"entry_date,type:datetime"`                                     // Date the note is created
