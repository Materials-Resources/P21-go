...
type InventorySupplierTrade struct {
	...
	CertificateOfOriginFilePath *string          `bun:"certificate_of_origin_file_path,type:varchar(255)"`               // Path for CoO related to the inventory supplier.
	CertificateOfOriginExpDate  *mssql.DateTime1 `bun:"certificate_of_origin_exp_date,type:datetime"`                    // Expiration date tied to this inventory suppliers CoO.
	...
	CountryOfOrigin             *string          `bun:"country_of_origin,type:varchar(50)"`                              // The country of origin for the item/supplier.
}
