...
type ScheduledJobHistory struct {
	...
	ScheduledJobHistoryUid int32            `bun:"scheduled_job_history_uid,type:int,autoincrement,identity,pk"`                                                                                                                                 // identity & auto-incremented column
	ScheduledJobUid        int32            `bun:"scheduled_job_uid,type:int"`                                                                                                                                                                   // foreign key to scheduled_job
	JobRunAtDate           mssql.DateTime1  `bun:"job_run_at_date,type:datetime"`                                                                                                                                                                // last time when job finished it's task
