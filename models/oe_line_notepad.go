...
type OeLineNotepad struct {
	...
	ActivationDate   mssql.DateTime1 `bun:"activation_date,type:datetime"`                                 // Date on which the note is activated.
	ExpirationDate   mssql.DateTime1 `bun:"expiration_date,type:datetime"`                                 // Date on which the note expires.
	EntryDate        mssql.DateTime1 `bun:"entry_date,type:datetime"`                                      // date the activity was entered
