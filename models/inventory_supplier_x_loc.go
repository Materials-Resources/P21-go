...
type InventorySupplierXLoc struct {
	...
	OverrideBegDate            *mssql.DateTime1 `bun:"override_beg_date,type:datetime"`                           // The beginning date for the vmi status override
	OverrideEndDate            *mssql.DateTime1 `bun:"override_end_date,type:datetime"`                           // The ending date for the vmi status override
	VmiLastSendDate            *mssql.DateTime1 `bun:"vmi_last_send_date,type:datetime"`                          // The last date that vmi data was exported for the supplier/location
