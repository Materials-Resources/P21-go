...
type ProcessPoShipmentHdr struct {
	...
	ShipDate                *mssql.DateTime1 `bun:"ship_date,type:datetime"`                                        // The date that the inventory for the associated Process PO was shipped.
	CarrierId               *float64         `bun:"carrier_id,type:decimal(19,0)"`                                  // The carrier for this shipment.
	TrackingNumber          *string          `bun:"tracking_number,type:varchar(255)"`                              // The tracking number for this shipment.
	Instructions            *string          `bun:"instructions,type:varchar(8000)"`                                // A note field for any shipping instructions related to this shipment
