...
type Address struct {
	...
	DefaultShipTime             *mssql.DateTime1 `bun:"default_ship_time,type:datetime"`                               // When should a shipment normally go out?
	...
	MorBegDelivery              *mssql.DateTime1 `bun:"mor_beg_delivery,type:datetime"`                                // When is the earliest that morning deliveries are accepted?
	MorEndDelivery              *mssql.DateTime1 `bun:"mor_end_delivery,type:datetime"`                                // When is the latest that morning deliveries are accepted?
	EveBegDelivery              *mssql.DateTime1 `bun:"eve_beg_delivery,type:datetime"`                                // When is the earliest that evening deliveries are accepted?
	EveEndDelivery              *mssql.DateTime1 `bun:"eve_end_delivery,type:datetime"`                                // When is the latest that evening deliveries are accepted?
