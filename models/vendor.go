...
type Vendor struct {
	...
	WorkersCompExpirationDate  *mssql.DateTime1 `bun:"workers_comp_expiration_date,type:datetime"`                // This column is unused.
	GeneralLiabExpirationDate  *mssql.DateTime1 `bun:"general_liab_expiration_date,type:datetime"`                // This column is unused.
