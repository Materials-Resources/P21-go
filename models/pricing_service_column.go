...
type PricingServiceColumn struct {
	...
	TpcxAbbrevDate          *mssql.DateTime1 `bun:"tpcx_abbrev_date,type:datetime"`                                // Date sequence defined for TPCx abbreviated format
	...
	ActLayoutDate           *mssql.DateTime1 `bun:"act_layout_date,type:datetime"`                                 // Activant Pricing Service layout date
	...
	AqnetLayoutDate         *mssql.DateTime1 `bun:"aqnet_layout_date,type:datetime"`                               // Date the column_name was added to the support table
