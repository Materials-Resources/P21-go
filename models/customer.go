...
type Customer struct {
	...
	CreditCardExpirationDate             *mssql.DateTime1 `bun:"credit_card_expiration_date,type:datetime"`                     // The month and year a credit card expires.
	...
	LastCheckDate                        *mssql.DateTime1 `bun:"last_check_date,type:datetime"`                                 // Date of the last check received from the customer.
	...
	LastFcDate                           *mssql.DateTime1 `bun:"last_fc_date,type:datetime"`                                    // Indicates the date when finance charges for this customer were last calculated.
	...
	DateAcctOpened                       *mssql.DateTime1 `bun:"date_acct_opened,type:datetime"`                               // Date the customer account became active.
	...
	SalesrepAssignedDate                 *mssql.DateTime1 `bun:"salesrep_assigned_date,type:datetime"`                       // The date that the sales rep was assigned to the customer
	...
	SfdcCreateDate                       *mssql.DateTime1 `bun:"sfdc_create_date,type:datetime"`                               // Date the record was created in Salesforce.com - added by import.
	SfdcUpdateDate                       *mssql.DateTime1 `bun:"sfdc_update_date,type:datetime"`                               // Date the record was updated in Salesforce.com - added by import.
	...
	Zoom360GradeExpirationDate           *mssql.DateTime1 `bun:"zoom360_grade_expiration_date,type:datetime"`                  // Date that Zoom 360 grade expires and is no longer valid
	...
	StartConsolidationDate               *mssql.DateTime1 `bun:"start_consolidation_date,type:datetime"`                            // Start Consolidation Date
	...
	Edi832LastFullRunDate                *mssql.DateTime1 `bun:"edi832_last_full_run_date,type:datetime"`                           // Date time when the EDI 832 export was run fully for this customer. (Custom)
