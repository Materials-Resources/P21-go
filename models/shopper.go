...
type Shopper struct {
	...
	DateLastLogon       *mssql.DateTime1 `bun:"date_last_logon,type:datetime"`                                                                                                                                                                                                 // Date the shopper lasts logged on.
	DateLastLogoff      *mssql.DateTime1 `bun:"date_last_logoff,type:datetime"`                                                                                                                                                                                                // Date the shopper lasts logged off.
