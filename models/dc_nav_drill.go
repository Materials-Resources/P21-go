...
type DcNavDrill struct {
	...
	SourceDatawindow     *string         `bun:"source_datawindow,type:varchar(255)"`                          // DataWindow drilling from
	...
	DestDatawindow       *string         `bun:"dest_datawindow,type:varchar(255)"`                            // DataWindow navigating to
	...
	DestWindowName       *string         `bun:"dest_window_name,type:varchar(255)"`                           // Name of the drill target window
	SourceDataField      *string         `bun:"source_data_field,type:varchar(255)"`                          // Used when data needed for drill is not in the clicked field.
