...
type LostSalesTransaction struct {
	...
	LineNo                  *int32          `bun:"line_no,type:int"`                                              // The line of the transaction this reason is associated with.
	SubLineNo               *int32          `bun:"sub_line_no,type:int"`                                          // Row for detail records of the main transaction row (assembly components, releases, etc).
	SkuQtyChange            *float64        `bun:"sku_qty_change,type:decimal(19,9)"`                             // The change in qty this reason is associated with.
