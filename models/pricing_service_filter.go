...
type PricingServiceFilter struct {
	...
	Operand          *string         `bun:"operand,type:varchar(255)"`                                 // The comparison operator for the filter
	FilterValue      *string         `bun:"filter_value,type:varchar(50)"`                             // The value to be used as the comparison in the filter
