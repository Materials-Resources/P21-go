...
type SummaryPoLocDaily struct {
	...
	SummaryPoLocDailyUid int32           `bun:"summary_po_loc_daily_uid,type:int,autoincrement,identity,pk"`
	CompanyId            string          `bun:"company_id,type:varchar(8),unique"`
	LocationId           float64         `bun:"location_id,type:decimal(19,0),unique"`
	SummaryDate          mssql.DateTime1 `bun:"summary_date,type:datetime,unique"`
