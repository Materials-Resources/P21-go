...
type ArPaymentDetails struct {
	...
	PaymentDate                 mssql.DateTime1  `bun:"payment_date,type:datetime"`                                // Date payment accepted
	...
	CcExpirationDate            *mssql.DateTime1 `bun:"cc_expiration_date,type:datetime"`                          // Credit Card Expiration Date
	CcAuthorizedDate            *mssql.DateTime1 `bun:"cc_authorized_date,type:datetime"`                          // Credit Card Authorization Date
	...
	ExchangeRateOverrideDate    *mssql.DateTime1 `bun:"exchange_rate_override_date,type:datetime"`         // Indicate that the user choose to override the effective exchange rate, based on this date, applied to a foreign currency payment.  Currency_line_uid should reflect the exchange rate for this date.
