...
type JobPriceLine struct {
	...
	ExpirationDate              *mssql.DateTime1 `bun:"expiration_date,type:datetime"`                              // The date when this item expires from this contract
	...
	LineStartDate               *mssql.DateTime1 `bun:"line_start_date,type:datetime"`                              // Start date at the line level for the item on the contract.
