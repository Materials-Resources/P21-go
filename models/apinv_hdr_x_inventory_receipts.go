...
type ApinvHdrXInventoryReceipts struct {
	...
	DateCreated             mssql.DateTime1 `bun:"date_created,type:datetime,default:('CURRENT_TIMESTAMP')"`       // Date and time the record was originally created
	DateLastModified        mssql.DateTime1 `bun:"date_last_modified,type:datetime,default:('CURRENT_TIMESTAMP')"` // Date and time the record was modified
