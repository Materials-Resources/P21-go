...
type TaxRegimeMx struct {
	...
	TaxRegimeMxUid    int32            `bun:"tax_regime_mx_uid,type:int,autoincrement,identity,pk"`         // Primary Key
	...
	UseForPersonFlag  *string          `bun:"use_for_person_flag,type:char(1)"`                             // Whether this regime is applied for person
	UseForCompanyFlag *string          `bun:"use_for_company_flag,type:char(1)"`                            // Whether this regime is applied for company
