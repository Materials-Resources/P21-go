...
type DemandPatternCriteria struct {
	...
	LastEvaluationDate        mssql.DateTime1 `bun:"last_evaluation_date,type:datetime"`                           // Do not include items which have had their demand pattern identified since this date.
