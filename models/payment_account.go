...
type PaymentAccount struct {
	...
	AcctExpirationDate   *mssql.DateTime1 `bun:"acct_expiration_date,type:datetime"`                           // Datetime indicating the expiration date (nullable in the case of check/EFT, PayPal, etc)
