...
type ProdOrderLine struct {
	...
	RequiredDate                 *mssql.DateTime1 `bun:"required_date,type:datetime"`                             // The date in which this production order line item required.
	ExpediteDate                 *mssql.DateTime1 `bun:"expedite_date,type:datetime"`                             // The date in which this assembly line item needs to be expedited
	...
	CommittedStartDate           *mssql.DateTime1 `bun:"committed_start_date,type:datetime"`                      // Date user commits to starting the assembly
	StartDate                    *mssql.DateTime1 `bun:"start_date,type:datetime"`                                // Date production order is printed
	EndDate                      *mssql.DateTime1 `bun:"end_date,type:datetime"`                                  // Actual date assembly is finished
	CommentDate                  *mssql.DateTime1 `bun:"comment_date,type:datetime"`                              // User-defined date
