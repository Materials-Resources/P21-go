...
type ShipTo struct {
	...
	MorningBegDelivery            *mssql.DateTime1 `bun:"morning_beg_delivery,type:datetime"`                            // When should morning deliveries begin?
	MorningEndDelivery            *mssql.DateTime1 `bun:"morning_end_delivery,type:datetime"`                            // When should morning deliveries end?
	EveningBegDelivery            *mssql.DateTime1 `bun:"evening_beg_delivery,type:datetime"`                            // When should evening deliveries begin?
	EveningEndDelivery            *mssql.DateTime1 `bun:"evening_end_delivery,type:datetime"`                            // When are evening deliveries over?
	...
	DateAcctOpened                *mssql.DateTime1 `bun:"date_acct_opened,type:datetime"`                               // Date the ship to account became active.
